    ...
    selectTab(nextIndex, presentIndex) {
        ...
        if (presentIndex == 0) {
            if (this.listingBuyer.title == null ||
                ...
                Math.floor(Math.abs(Date.now() - new Date(this.listingBuyer.DOB).getTime()) / (1000 * 3600 * 24) / 365.25)
                    < 18 ||
    ...
    selectTab(nextIndex, presentIndex) {
        if (presentIndex == 0) {
            if (this.listingSeller.Title == null ||
                ...
                Math.floor(Math.abs(Date.now() - new Date(this.listingSeller.DOB).getTime()) / (1000 * 3600 * 24) / 365.25)
                    < 18 ||
