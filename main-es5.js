...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        value: function ngOnInit() {
          ...
          this.MatchesService.getSellerProperties(this.uid).subscribe(function (ref) {
            ref.forEach(function (item) {
              ...
              console.log("from the localStorage " + JSON.stringify(_this6.stateService.listingBuyer.Lookingpostcode));

              if (item.data().Lookingpostcode == _this6.stateService.listingBuyer.Lookingpostcode) {
      ...
      _createClass(ConfirmBuyerDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.postcodeService.getLat(this.listingBuyer.Lookingpostcode).subscribe(function (data) {
            ...
            _this9.return = _this9.formsService.createCustomer(_this9.userData.uid, _this9.listingBuyer).then(function (data) {
              if (data == true) {
                _this9.isBuyer = false;
              }
            });
          });
        }
  ...
  function srcAppHomePropertyFillFormSellerConfirmSellerDetailConfirmSellerDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ConfirmSellerDetailComponent(activatedRoute, SellerformService, authService, afAuth, stateService, dialog, snackBar, route, _location, postcodeService, ConfirmsellerDetailService) {
      ...
      _createClass(ConfirmSellerDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.postcodeService.getLat(this.listingSeller.Lookingpostcode).subscribe(function (data) {
            ...
            _this23.return = _this23.SellerformService.createCustomer(_this23.userData.uid, _this23.listingSeller).then(function (data) {
              if (data == true) {
                _this23.isBuyer = false;
                console.log(_this23.listingSeller.latitude);
              }
            });
          });
        }
      ...
      _createClass(SellerMatchListingComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.SellermatchesService.getSellerProperties(this.uid).subscribe(function (res) {
            res.forEach(function (item) {
              if (item.data().Lookingpostcode == _this25.stateService.listingSeller.Lookingpostcode) {
                ...
                var _loop = function _loop(i) {
                  _this25.SellermatchesService.getUser(_this25.matchedProperties[i].UserId).subscribe(function (ref) {
                    ref.forEach(function (elements) {
                      if (_this25.matchedProperties[i].UserId == elements.data().uid) {
                        _this25.Names = elements.data().Name;
                        _this25.title = elements.data().title;
                        console.log(_this25.Names);
                      }
                    });
                  });
                };

                for (var i = 0; i < _this25.matchedProperties.length; i++) {
                  _loop(i);
                }
              } else if (item.data().latitude && item.data().longitude) {
                ...
                console.log(_this25.unmatchedProperties);
              } else {
                _this25.unmatchedProperties.push({
                  detail: item.data()
                });
                ...
                console.log(_this25.unmatchedProperties[0].detail.UserId);

                var _loop2 = function _loop2(_i) {
                  _this25.SellermatchesService.getUser(_this25.unmatchedProperties[_i].detail.UserId).subscribe(function (dref) {
                    dref.forEach(function (element) {
                      if (_this25.unmatchedProperties[_i].detail.UserId == element.data().uid) {
                        _this25.unNamed = element.data().Name;
                        console.log(_this25.unNamed);
                      }
                    });
                  });
                };

                for (var _i = 0; _i < _this25.unmatchedProperties.length; _i++) {
                  _loop2(_i);
                }
              }
            });
            ...
            _this25.noOfUnmatched = _this25.unmatchedProperties.length;
            console.log(_this25.matchedProperties[0]);
          });
        }
      }, {
        key: "getDistanceFromLatLonInKm",
          ...
          if (presentIndex == 0) {
            ...
            if (nextIndex > presentIndex) {
              if (this.user.Currentpostcode == null) {
                ...
                var _dialogRef33 = this.dialog.open(_Misc_alertFormdialog_alertFormdialog_component__WEBPACK_IMPORTED_MODULE_15__["AltertFormDialogComponent"], {
                  data: {
                    message: "Please Select Ownership"
                  }
                });
              } else if (this.listingSeller.features == null) {
                var _dialogRef34 = this.dialog.open(_Misc_alertFormdialog_alertFormdialog_component__WEBPACK_IMPORTED_MODULE_15__["AltertFormDialogComponent"], {
                  data: {
      ...
      _createClass(MyMatchesSelectedDetailsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
            ...
            _this38.norooms = params.get("norooms");
            _this38.PropertyCondition = params.get("PropertyCondition");
            _this38.MinAmount = params.get("MinAmount");
        ...
        value: function ngOnInit() {
          ...
          this.MatchesService.getMatchesSellerProperties(this.uid).then(function (res) {
            res.forEach(function (element) {
              ...
              console.log("Seller matches " + JSON.stringify(_this40.sellerProperty));
            });
          ...
          this.MatchesService.getMatchesBuyerProperties(this.uid).then(function (res) {
            res.forEach(function (element) {
              ...
              console.log("Buyer matches " + JSON.stringify(_this40.buyerProperty));
            });
          });
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./terms-condition/terms-condition.component */
    "./src/app/terms-condition/terms-condition.component.ts"); // Firebase modules
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! K:\Angular Project\checki\streethok\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
