...
const routes = [
    ...
    { path: "mymatchesselecteddetail/:Lookingpostcode/:LookingAddress/:norooms/:PropertyCondition/:MinAmount/:Lookingstate/:PropertyType/:ownership/:features/:matchStatus", component: _Menu_myMatches_my_matches_selected_details_my_matches_selected_details_component__WEBPACK_IMPORTED_MODULE_24__["MyMatchesSelectedDetailsComponent"] },
    ...
    { path: "MyMatchesseller/:Lookingpostcode/:Lookingstate/:LookingAddress/:norooms/:PropertyCondition/:MinAmount/:PropertyType/:ownership/:matchStatus", component: _Menu_myMatches_my_matches_to_sell_selected_detail_my_matches_to_sell_selected_detail_component__WEBPACK_IMPORTED_MODULE_28__["MyMatchesToSellSelectedDetailComponent"] },
];
