  ...
  function srcAppFormsFormsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      formsService, firestore, afAuth, db, dialog, snackBar, route, router, stateService) {
        ...
        this.isLoading = false;
        this.version = _angular_material__WEBPACK_IMPORTED_MODULE_7__["VERSION"]; // options: string[] = ['SW5101', 'NW7W25', 'W25R43'];
        ...
        this.filteredStates = this.postcodeFormControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(function (state) {
          return state ? _this7._filterStates(state) : _this7.states.slice();
        }));
      }
  ...
  function srcAppSellerformSellerformComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      afAuth, firestore, SellerformService, dialog, snackBar, route, router, stateService) {
        ...
        this.filteredStates = this.postcodeFormControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(function (state) {
          return state ? _this15._filterStates(state) : _this15.states.slice();
        }));
      }
        ...
        value: function ngOnInit() {
          ...
          this.SellermatchesService.getSellerProperties(this.uid).subscribe(function (res) {
            res.forEach(function (item) {
              if (item.data().postcode == _this17.stateService.Seller.postcode) {
