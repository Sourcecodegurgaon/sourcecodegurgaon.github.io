...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        value: function ngOnInit() {
          ...
          this.BuyerdetailService.getUser(this.uid).subscribe(function (ref) {
            ref.forEach(function (element) {
              if (element.data().uid == _this10.uid) {
                _this10.user.Name = element.data().Name;
                _this10.user.Email = element.data().email;
                _this10.user.DOB = element.data().DOB;
                _this10.user.Phone = element.data().Phone;
          ...
          this.fillFormsService.getUser(this.uid).subscribe(function (ref) {
            ref.forEach(function (element) {
              if (element.data().uid == _this13.uid) {
                ...
                _this13.user.DOB = element.data().DOB;
      ...
      _createClass(ConfirmSellerDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ConfirmsellerDetailService.getUser(this.uid).subscribe(function (ref) {
            ref.forEach(function (element) {
              if (element.data().uid == _this15.uid) {
                ...
                _this15.user.DOB = element.data().DOB;
          ...
          this.postcodeService.getLat(this.listingSeller.Lookingpostcode).subscribe(function (data) {
            ...
            _this15.listingSeller.longitude = _this15.postcodeCoordinates.result.longitude, _this15.listingSeller.latitude = _this15.postcodeCoordinates.result.latitude, _this15.listingSeller.UserId = _this15.userData.uid, _this15.isBuyer = true;
            _this15.return = _this15.SellerformService.createCustomer(_this15.userData.uid, _this15.listingSeller).then(function (data) {
              if (data == true) {
                _this15.isBuyer = false;
                console.log(_this15.listingSeller.latitude);
              }
            });
          });
        }
        ...
        value: function submitForm() {
          ...
          this.return = this.SellerformService.createCustomer(this.userData.uid, this.listingSeller).then(function (data) {
            if (data == true) {
              ...
              var dialogRef = _this16.dialog.open(_alertDialogSellerDataSubmission_component__WEBPACK_IMPORTED_MODULE_8__["AlertDialogComponent"], {
                data: {
                  message: "HelloWorld",
                  buttonText: {
                    cancel: "Done"
        ...
        value: function ngOnInit() {
          ...
          this.SellermatchesService.getSellerProperties(this.uid).subscribe(function (res) {
            res.forEach(function (item) {
              if (item.data().Lookingpostcode == _this17.stateService.listingSeller.Lookingpostcode) {
                _this17.matchedProperties.push(item.data()); //Use this object to populate html

              } else if (item.data().latitude && item.data().longitude) {
                // console.log(item.data().postcode.latitude);
                _this17.distanceInKm = _this17.getDistanceFromLatLonInKm(_this17.stateService.listingSeller.latitude, _this17.stateService.listingSeller.longitude, item.data().latitude, item.data().longitude);
            ...
            _this17.noOfMatches = _this17.matchedProperties.length;
            _this17.noOfUnmatched = _this17.unmatchedProperties.length;
    ...
    function () {
      ...
      _createClass(SellerSelectedPropertyComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.uid = this.user.uid;
          this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
            _this18.LookingStreetname = params.get("LookingStreetname");
            _this18.Lookingpostcode = params.get("Lookingpostcode");
            _this18.PropertyType = params.get("PropertyType");
            _this18.Conditions = params.get("Conditions");
            _this18.ChainStatus = params.get("ChainStatus");
            _this18.FinancialPosition = params.get("FinancialPosition");
            _this18.SearchRadius = params.get("SearchRadius");
            _this18.PriceRange = params.get("PriceRange");
            _this18.Validity = params.get("Validity");
            _this18.Type = params.get("Type");
            _this18.Position = params.get("Position");
            _this18.UserId = params.get("UserId").replace(/\s/g, "");
            _this18.norooms = params.get("norooms");
          });
          console.log("user id" + this.UserId);
        ...
        value: function submitForm() {
          ...
          this.return = this.seller_Selected_propertydetail_Service.matchesSellerCreate(this.uid, this.matchesSeller).then(function (data) {
            if (data == true) {
              _this19.isSellerSelected = false;

              var dialogRef = _this19.dialog.open(_Misc_selectedPropertyDialog_selectedPropertyDialog_component__WEBPACK_IMPORTED_MODULE_5__["SelectedPropertyDialogComponent"], {
                data: {
                  buttonText: {
                    cancel: "Done"
                  }
    ...
    function () {
      ...
      _createClass(FillFormSellerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["switchMap"])(function (value) {
            if (value !== "") {
              _this20.lookup(_this20.listingSeller.Lookingpostcode).subscribe(function (data) {
                _this20.data = data;
              });

              return _this20.lookup(_this20.listingSeller.Lookingpostcode);
            } else {
          ...
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["switchMap"])(function (value) {
            if (value !== "") {
              _this20.lookup(_this20.listingSeller.Currentpostcode).subscribe(function (data) {
                _this20.data = data;
              });

              return _this20.lookup(_this20.listingSeller.Currentpostcode);
            } else {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["of"])(null);
            }
          }));
        ...
        value: function LoggedIn() {
          ...
          this.SellerformService.getUser(this.uid).subscribe(function (ref) {
            ref.forEach(function (element) {
              if (element.data().uid == _this21.uid) {
                _this21.user.Name = element.data().Name;
                _this21.user.Email = element.data().email;
                _this21.user.DOB = element.data().DOB;
                _this21.user.Phone = element.data().Phone;
                console.log(element.data().Name);
              }
            });
          });
        ...
        value: function ngOnInit() {
          ...
          this.myrequirement_service.getBuyerRequirement(this.uid).then(function (res) {
            res.forEach(function (element) {
              _this24.propertyRequirementDetails.push(element.data());
            });
          });
          this.myrequirement_service.getSellerProperties(this.uid).then(function (res) {
            res.forEach(function (element) {
              _this24.propertyDetails.push(element.data());

              console.log(_this24.propertyDetails);
            });
          });
        }
      }]);
      ...
      _createClass(MyMatchesSelectedDetailsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
            ...
            _this25.Lookingstate = params.get("Lookingstate");
            _this25.LookingAddress = params.get("LookingAddress");
            _this25.norooms = params.get("norooms");
            _this25.PropertyCondition = params.get("PropertyCondition");
            _this25.MinAmount = params.get("MinAmount");
            _this25.PropertyType = params.get("PropertyType");
            _this25.ownership = params.get("ownership");
            _this25.features = params.get("features");
      ...
      _createClass(MyMatchesToSellSelectedDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
            ...
            _this26.ChainStatus = params.get("ChainStatus");
            _this26.FinancialPosition = params.get("FinancialPosition");
            _this26.Type = params.get("Type");
            _this26.Position = params.get("Position");
            _this26.SearchRadius = params.get("SearchRadius");
            _this26.PriceRange = params.get("PriceRange");
            _this26.matchStatus = params.get("matchStatus");
          });
        }
      }]);
        ...
        value: function ngOnInit() {
          ...
          this.MatchesService.getMatchesSellerProperties(this.uid).then(function (res) {
            res.forEach(function (element) {
              ...
              _this27.sellerProperty.push(element.data());

              console.log("Seller matches " + JSON.stringify(_this27.sellerProperty));
            });
          ...
          this.MatchesService.getMatchesBuyerProperties(this.uid).then(function (res) {
            res.forEach(function (element) {
              ...
              _this27.buyerProperty.push(element.data());

              console.log("Buyer matches " + JSON.stringify(_this27.buyerProperty));
            });
          });
        }
      }]);
      ...
      _createClass(NavigationBarComponent, [{
        ...
        value: function getMatchCases() {
          ...
          this.MatchesService.getMatchesSellerProperties(this.uid).then(function (res) {
            ...
            _this29.noSellerOfMatche = _this29.sellerProperty.length;
            console.log(_this29.noSellerOfMatche);
            _this29.matches = _this29.buyerProperty.length + _this29.sellerProperty.length;
            console.log(_this29.matches);
          }); // Fetch details Seller
          ...
          this.MatchesService.getMatchesBuyerProperties(this.uid).then(function (res) {
            ...
            _this29.noBuyerMatches = _this29.buyerProperty.length;
            console.log(_this29.noBuyerMatches);
            _this29.matches = _this29.buyerProperty.length + _this29.sellerProperty.length;
            console.log(_this29.matches);
          });
        }
  ...
  function srcAppAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _location) {
        ...
        this.afAuth.authState.subscribe(function (user) {
          if (user) {
            _this30.userData = user;
            localStorage.setItem("user", JSON.stringify(_this30.userData));
          } else {
            localStorage.setItem("user", null);
          }
        });
  ...
  function srcAppTemplateTemplateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function TemplateComponent(authService, afAuth, route, router) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /media/god/Main Data/Angular Project/checki/streethok/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
