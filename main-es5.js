...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppFormsFormsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _requireMatch__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./requireMatch */
    "./src/app/forms/requireMatch.ts");
    /* harmony import */


    var _ukpincodes__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./ukpincodes */
    ...
    function () {
      ...
      _createClass(FormsComponent, [{
        ...
        key: "displayWith",
        value: function displayWith(obj) {
  ...
  /***/
  function srcAppFormsRequireMatchTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFormsUkpincodesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "proj", function () {
      return proj;
    });
    /* harmony import */
        ...
        value: function ngOnInit() {
          ...
          this.MatchesService.getSellerProperties(this.uid).subscribe(function (ref) {
            ref.forEach(function (item) {
              if (item.data().postcode == _this8.stateService.Buyer.postcode) {
                _this8.matchedProperties.push(item.data()); //Use this object to populate html

              } else if (item.data().postcode.latitude && item.data().postcode.longitude) {
                console.log(item.data().postcode.latitude);
                _this8.distanceInKm = _this8.getDistanceFromLatLonInKm(_this8.stateService.Buyer.postcode.latitude, _this8.stateService.Buyer.postcode.longitude, item.data().postcode.latitude, item.data().postcode.longitude);
            ...
            console.log(_this8.matchedProperties);
          });
        }
      }, {
  ...
  /***/
  function srcAppSellerformRequireMatchTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
            ...
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    _context8.next = 2;
                    return this.customersRef.doc(key).collection("properties").add(Object.assign({}, customer)).then(function (data) {// console.log("Document successfully written!");
                    });
  ...
  /***/
  function srcAppSellerformUkpincodesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
          ...
          this.SellermatchesService.getSellerProperties(this.uid).subscribe(function (res) {
            res.forEach(function (item) {
              if (item.data().postcode == _this15.stateService.Seller.postcode) {
                ...
                console.log(item.data().postcode.latitude);
                _this15.distanceInKm = _this15.getDistanceFromLatLonInKm(_this15.stateService.Seller.postcode.latitude, _this15.stateService.Seller.postcode.longitude, item.data().postcode.latitude, item.data().postcode.longitude);
                ...
                _this15.unmatchedProperties.push(item.data());
