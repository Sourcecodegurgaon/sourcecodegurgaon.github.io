...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        value: function ngOnInit() {
          ...
          this.MatchesService.getSellerProperties(this.uid).subscribe(function (ref) {
            ref.forEach(function (item) {
              if (item.data().Lookingpostcode == _this7.stateService.listingBuyer.Lookingpostcode.postcode) {
            ...
            _this7.unmatchedProperties.sort(_this7.compare); //console.log(this.unmatchedProperties);

          });
          console.log(this.MatchesService);
      ...
      _createClass(BuyerSelectedPropertyDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
            ...
            _this8.PropertyType = params.get("PropertyType");
            ...
            _this8.UserId = params.get("UserId");
          });
        ...
        value: function submitForm() {
          ...
          this.isBuyerSelected = true;
          this.return = this.Selected_propertydetail_Service.matchesSellerCreate(this.matchesBuyer.userId, this.matchesSeller).then(function (data) {
            if (data == true) {
              _this9.isBuyerSelected = false;
              console.log("Done");
            }
          ...
          this.postcodeService.getLat(this.listingBuyer.Lookingpostcode).subscribe(function (data) {
            ...
            _this10.return = _this10.formsService.createCustomer(_this10.userData.uid, _this10.listingBuyer).then(function (data) {
              if (data == true) {
                ...
                console.log(_this10.listingBuyer.latitude);
      ...
      _createClass(SellerSelectedPropertyComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
            ...
            _this16.UserId = params.get("UserId");
  ...
  function srcAppMenuMyMatchesMyMatchesSelectedDetailsMyMatchesSelectedDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function MyMatchesSelectedDetailsComponent() {
    ...
    function () {
      ...
      _createClass(MyMatchesService, [{
        ...
        value: function getMatchesSellerProperties(uid) {
          return this.propertiesRef.doc(uid).collection("matches").ref.get();
        }
      }, {
        key: "getMatchesBuyerProperties",
        value: function getMatchesBuyerProperties(uid) {
          return this.customersRef.doc(uid).collection("matches").ref.get();
        }
      }]);
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      path: "buyerSelectedpropertyDetail/:Lookingpostcode/:Lookingstate/:LookingTown/:norooms/:PropertyCondition/:MaxAmount/:LookingAddress/:ownership/:PropertyType/:features/:Firstname/:Lastname/:Email/:DOB/:UserId",
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/template/template.component.ts"); // Firebase modules
  ...
  function srcAppTemplateTemplateComponentCss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".back {\n    background-image: url(/assets/Images/handshake.jpg);\n    width: 100%;\n    height: auto;\n    background-repeat: no-repeat;\n    background-size: cover;\n  }\n  \n  .upper-back {\n    background-color: black;\n    width: 100%;\n    height: 250px;\n    opacity: 0.5;\n    font-family: 'Open Sans', sans-serif;\n  }\n  \n  .upper-button {\n    display: flex;\n    justify-content: space-around;\n    align-content: center;\n    z-index: 100;\n  \n    font-family: 'Open Sans', sans-serif;\n    position: relative;\n    top: -145px;\n  }\n  \n  .home-button {\n    background-color: #244D93;\n    color: white;\n    width: 35%;\n  }\n  \n  @font-face {\n    font-family: 'Segoe UI Regular';\n    font-style: normal;\n    font-weight: normal;\n    src: local('Segoe UI Regular'), url('/assets/font/Segoe UI.woff') format('woff');\n  }\n  \n  .home-text-font {\n    font-family: 'Segoe UI Regular';\n    color: #707070;\n    margin-bottom: 0.5rem;\n  }\n  \n  .btn-facebook {\n    background-color: #244D93;\n    color: white;\n    width: 30%;\n    height: 35px;\n    text-align: center;\n    margin: 0px;\n    padding: 0px;\n    font-family: 'Open Sans', sans-serif;\n  }\n  \n  .btn-google {\n    background-color: #DD4B33;\n    color: white;\n    width: 30%;\n    height: 35px;\n    text-align: center;\n    margin: 0px;\n    padding: 0px;\n    font-family: 'Open Sans', sans-serif;\n  }\n  \n  .social-login h4 {\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 700;\n  }\n  \n  .social-button {\n    display: flex;\n    /* justify-content: center; */\n    justify-content: space-evenly;\n    align-items: center;\n  \n  }\n  \n  .color-signup {\n    color: #244D93;\n  }\n  \n  .btn-social-login {\n    width: 100%;\n    background-color: #244D93;\n    color: white;\n    margin-top: 3%;\n    font-family: 'Open Sans', sans-serif;\n  \n  }\n  \n  i.fa.fa-user.input-group-text.nav-login-form {\n    position: absolute;\n    font-size: 23px;\n    left: 0px;\n    width: 10%;\n    z-index: 10;\n    margin-top: -4%;\n  }\n  \n  .social-login.text-center {\n    padding: 15px;\n  }\n  \n  .checkbox {\n    background: none transparent;\n    border: none;\n    border-left: none;\n    border-right: none;\n    cursor: pointer;\n    /* display: block; */\n    height: auto;\n    position: absolute;\n    top: none;\n    left: none;\n    right: 9px;\n    width: none;\n    /* transition: all .2s; */\n    display: flex;\n    flex-direction: row;\n  \n  }\n  \n  .example-form {\n    min-width: 150px;\n    max-width: 500px;\n    width: 100%;\n  }\n  \n  .example-full-width {\n    width: 100%;\n    border: none;\n  }\n  \n  .loading-container {\n    width: 100%;\n    height: 100%;\n    position: fixed;\n    top: 0px;\n    left: 0px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    z-index: 9;\n    background: black;\n    opacity: 0.5;\n  }\n  \n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/god/Desktop/streethok/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
