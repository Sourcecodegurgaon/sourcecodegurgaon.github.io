...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Loading spinner -->\n<div *ngIf=\"isLoading\" class=\"loading-container\">\n  <mat-progress-spinner mode=\"indeterminate\"></mat-progress-spinner>\n</div>\n\n<div class=\"container forms-container\">\n  <div class=\"row\">\n    <section class=\"col-12\">\n      <div class=\"social-login text-center mt-3 p-2\" *ngIf=\"!isLoggedIn\">\n        <h4>Login or <span class=\"color-signup\">Sign up</span></h4>\n        <div class=\"social-button mt-4\">\n          <button type=\"button\" class=\"btn btn-facebook \" (click)=\"authService.FacebookAuth()\">\n            Facebook\n          </button>\n          <button type=\"button\" class=\"btn btn-google ml-4\" (click)=\"authService.GoogleAuth()\">\n            Google+\n          </button>\n        </div>\n        <div class=\"input-group mb-3 mt-3\">\n          <div class=\"input-group-prepend\">\n            <i class=\"fa fa-user input-group-text\" aria-hidden=\"true\"></i>\n          </div>\n          <input type=\"text\" class=\"form-control\" placeholder=\"Enter email\" #userEmail required />\n        </div>\n\n        <div class=\"input-group-prepend\">\n          <i class=\"fa fa-lock input-group-text\" aria-hidden=\"true\"></i>\n          <input type=\"Password\" class=\"form-control\" placeholder=\"Password\" #userPassword required />\n        </div>\n\n        <div class=\"input-group-prepend other-option\">\n          <label class=\"checkbox\">\n            <input type=\"checkbox\" value=\"remember-me\" />Remember Me\n          </label>\n          <a href=\"#\" class=\"forgot-password\">Forgot password?</a>\n        </div>\n        <button type=\"button\" class=\"btn btn-social-login\"\n          (click)=\"authService.SignIn(userEmail.value, userPassword.value)\">\n          Login\n        </button>\n        <button type=\"button\" class=\"btn btn-social-login\"\n          (click)=\"authService.SignUp(userEmail.value, userPassword.value)\">\n          Sign Up\n        </button>\n      </div>\n\n\n      <form role=\"form\" (ngSubmit)=\"onSubmit()\">\n        <mat-tab-group #matgroup class=\"form-tab-conatiner\">\n          <mat-tab label=\"Personal Details\">\n            <div class=\"tab-pane active\" role=\"tabpanel\" id=\"step1\">\n              <h4 class=\"mt-4 forms-heading\">Personal Details</h4>\n              <p class=\"forms-star\">*required</p>\n\n              <div class=\"form-group\">\n                <label for=\"pwd\">Title*</label>\n                <select name=\"title\" [(ngModel)]=\"Seller.Title\" class=\"drop-down-list\">\n                  <option value=\"Mr\">Mr</option>\n                  <option value=\"Mrs\">Mrs</option>\n                  <option value=\"Ms\">Ms</option>\n                </select>\n              </div>\n\n              <div class=\"form-group\">\n                <label for=\"pwd\">First Name*</label>\n                <input type=\"text\" class=\"form-control\" d=\"name\" required [(ngModel)]=\"Seller.Firstname\"\n                  name=\"Firstname\" required />\n              </div>\n              <div class=\"form-group\">\n                <label for=\"pwd\">Last Name*</label>\n                <input type=\"text\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.Lastname\" name=\"Lastname\"\n                  required />\n              </div>\n              <div class=\"form-group\">\n                <label for=\"pwd\">Email Address*</label>\n                <input type=\"email\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.Email\" name=\"Email\"\n                  required />\n              </div>\n              <div class=\"form-group\">\n                <label for=\"pwd\">Date of Birth*</label>\n                <input type=\"date\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.DOB\" name=\"DOB\"\n                  required />\n              </div>\n              <div class=\"form-group\" *ngIf=\"!isLoggedIn\">\n                <label for=\"pwd\">Enter A Password*</label>\n                <input type=\"password\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.Password\"\n                  name=\"Password\" required />\n              </div>\n              <div class=\"form-group\" *ngIf=\"!isLoggedIn\">\n                <label for=\"pwd\">Enter Password Again*</label>\n                <input type=\"password\" class=\"form-control\" id=\"name\" [(ngModel)]=\"Seller.Confirm\" name=\"Confirm\"\n                  required />\n              </div>\n              <ul class=\"submit-button\">\n                <div class=\"button-next\">\n                  <a (click)=\"matgroup.selectedIndex = 1\" class=\"btn btn-primary btnNext btn-next\">Next</a>\n                </div>\n              </ul>\n            </div>\n          </mat-tab>\n\n          <mat-tab label=\"Property Details\">\n            <div class=\"tab-pane\" role=\"tabpanel\" id=\"step2\">\n              <div class=\"seller-form-upper\">\n                <p>\n                  Property Enquiry<br />\n                  <span>Please fill the form below to list your property</span>\n                </p>\n                <hr class=\"top-hr\" />\n              </div>\n              <div class=\" container  forms-container\">\n                <p>Search by Address</p>\n\n                <div class=\"form-group\">\n                  <label for=\"email\">Address 1*</label>\n                  <input type=\"text\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.Address\" name=\"Address\"\n                    required />\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"pwd\">Town/City*</label>\n                  <input type=\"text\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.Town\" name=\"Town\"\n                    required />\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"pwd\">State/Provience/Country</label>\n                  <input type=\"text\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.state\" name=\"state\" />\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"pwd\">Postcode*</label>\n                  <input type=\"number\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.postcode\"\n                    name=\"postcode\" required />\n                </div>\n                <div class=\"form-group mt-4\">\n                  <label for=\"country\">Country*</label>\n                  <select name=\"Country\" [(ngModel)]=\"Seller.Country\" class=\"drop-down-list\">\n                    <option value=\"Austria\">Austria</option>\n                    <option value=\"India\">India</option>\n                    <option value=\"Australia\">Australia</option>\n                  </select>\n                </div>\n\n                <div class=\"form-group\">\n                  <label for=\"address_name\">Address Name</label>\n                  <input type=\"text\" class=\"form-control\" id=\"address_name\" required [(ngModel)]=\"Seller.Addressname\"\n                    name=\"Addressname\" />\n                </div>\n\n                <div class=\"form-group mt-4\">\n                  <label for=\"propertytype\">Property type*</label>\n                  <select name=\"PropertyType\" [(ngModel)]=\"Seller.PropertyType\" class=\"drop-down-list\">\n                    <option value=\"Terrace House\">Terrace House</option>\n                    <option value=\"Semi Detached House\">Semi Detached House</option>\n                    <option value=\"Detached House\">Detached House</option>\n                    <option value=\"End Of Terrace House\">End Of Terrace House</option>\n                    <option value=\"Masionette\">Masionette</option>\n                    <option value=\"Purpose-Built Flat\">Purpose-Built Flat</option>\n                  </select>\n                </div>\n                <div class=\"form-group mt-3\">\n                  <label for=\"pwd\">Number of Rooms*</label>\n                  <input type=\"number\" class=\"form-control\" id=\"name\" required [(ngModel)]=\"Seller.norooms\"\n                    name=\"norooms\" />\n                </div>\n\n                <div class=\"container mt-4\">\n                  <label for=\"pwd\">Expected Amount (Offer) *</label>\n                  <mat-slider style=\"width: 100%\" name=\"ExpectedAmount\" [(ngModel)]=\"Seller.ExpectedAmount\" min=\"0\"\n                    max=\"1000000\" step=\"1000\" thumbLabel tickInterval=\"1\">\n                  </mat-slider>\n                </div>\n\n                <div class=\"radio-main-container\">\n                  <div class=\"row\">\n                    <label class=\"col-6\" for=\"radio\">Property Condition:</label>\n                    <div class=\"form-check col-6 radio-align\" [(ngModel)]=\"Seller.PropertyCondition\"\n                      value=\"PropertyCondition\">\n                      <label class=\"form-check-label\" for=\"radio1\" class=\"drop-down-list\">\n                        <input type=\"radio\" class=\"form-check-input\" id=\"radio1\" name=\"optradio\"\n                          value=\"Newly Refurbished\" checked />Newly Refurbished\n                      </label>\n\n                      <label class=\"form-check-label\" for=\"radio2\">\n                        <input type=\"radio\" class=\"form-check-input\" id=\"radio2\" name=\"optradio\"\n                          value=\"Refurbished\" />Refurbished\n                      </label>\n\n                      <label class=\"form-check-label\">\n                        <input type=\"radio\" class=\"form-check-input\" value=\"New Build\" />New Build\n                      </label>\n\n                      <label class=\"form-check-label\">\n                        <input type=\"radio\" class=\"form-check-input\" value=\"Needs modernisation\" />Needs modernisation\n                      </label>\n                    </div>\n                  </div>\n                </div>\n\n                <label class=\"col-6\" for=\"radio\">Ownership:</label>\n                <select name=\"Propertytype\" [(ngModel)]=\"Seller.ownership\" value=\"ownership\" class=\"drop-down-list\">\n                  <option value=\"Freehold\">Freehold</option>\n                  <option value=\"Leasehold\">Leasehold</option>\n                  <option value=\"Share of Freehold\">Share of Freehold</option>\n                </select>\n\n                <label for=\"text\" class=\"mt-3\">Select the Applicable Features:</label>\n                <div class=\"row checkbox-check\">\n                  <div class=\"form-check col-6 row-check \">\n                    <label class=\"form-check-label\" for=\"check\" [(ngModel)]=\"Seller.ApplicableFeatures\"\n                      value=\"ApplicableFeatures\">\n                      <input type=\"checkbox\" class=\"form-check-input\" id=\"check1\" name=\"option1\"\n                        value=\"Driveway\" />Driveway\n                    </label>\n\n                    <label class=\"form-check-label\" for=\"check1\">\n                      <input type=\"checkbox\" class=\"form-check-input\" [(ngModel)]=\"Seller.ApplicableFeatures\"\n                        value=\"ApplicableFeatures\" value=\"Periodfeatures\" />Period features\n                    </label>\n\n                    <label class=\"form-check-label\" for=\"check1\">\n                      <input type=\"checkbox\" class=\"form-check-input\" id=\"check1\" name=\"option1\"\n                        value=\"something\" />Garage\n                    </label>\n                  </div>\n                  <div class=\"form-check col-6 row-check \">\n                    <label class=\"form-check-label\" for=\"check1\">\n                      <input type=\"checkbox\" class=\"form-check-input\" id=\"check1\" name=\"option1\"\n                        value=\"something\" />Wheelchair friendly\n                    </label>\n\n                    <label class=\"form-check-label\" for=\"check1\">\n                      <input type=\"checkbox\" class=\"form-check-input\" id=\"check1\" name=\"option1\"\n                        value=\"something\" />Gated community\n                    </label>\n\n                    <label class=\"form-check-label\" for=\"check1\">\n                      <input type=\"checkbox\" class=\"form-check-input\" id=\"check1\" name=\"option1\"\n                        value=\"something\" />External Rear Garden\n                    </label>\n                  </div>\n                </div>\n\n                <div class=\"button-next-tab2\">\n                  <a (click)=\"matgroup.selectedIndex = 0\" class=\"btn  btnPrevious btn-next\">Previous</a>\n                  <a (click)=\"matgroup.selectedIndex = 2\" class=\"btn btn-primary btnNext btn-next\">Next</a>\n                </div>\n\n              </div>\n            </div>\n          </mat-tab>\n\n          <mat-tab label=\"Optional Details\">\n            <div class=\"tab-pane\" role=\"tabpanel\" id=\"step3\">\n              <div class=\"seller-form-upper\">\n                <p>\n                  List Your Property<br />\n                  <span>Please fill the form below to list your property</span>\n                </p>\n                <hr class=\"top-hr\" />\n              </div>\n              <h4 class=\"mt-4 forms-heading\">Optional Details</h4>\n\n              <div class=\"forms-container\">\n                <p class=\"mt-4 forms-heading-optional\">\n                  Upload Property Images*\n                </p>\n\n                <div class=\"col-4 frmCaption\">Image 1*</div>\n                <div class=\"col-12\">\n                  <label class=\"customUpload btnUpload btnM\">\n                    <span>Choose files</span>\n\n                    <input type=\"file\" class=\"upload\" />\n                  </label>\n                </div>\n                <div class=\"col-4 frmCaption\">Image 2*</div>\n                <div class=\"col-12\">\n                  <label class=\"customUpload btnUpload btnM\">\n                    <span>Choose files</span>\n\n                    <input type=\"file\" class=\"upload\" />\n                  </label>\n                </div>\n                <div class=\"col-4 frmCaption\">Image 3*</div>\n                <div class=\"col-12\">\n                  <label class=\"customUpload btnUpload btnM\">\n                    <span>Choose files</span>\n\n                    <input type=\"file\" class=\"upload\" />\n                  </label>\n                </div>\n                <div class=\"col-4 frmCaption\">Image 4*</div>\n                <div class=\"col-12\">\n                  <label class=\"customUpload btnUpload btnM\">\n                    <span>Choose files</span>\n\n                    <input type=\"file\" class=\"upload\" />\n                  </label>\n                </div>\n                <div class=\"button-next-tab2\">\n                  <a (click)=\"matgroup.selectedIndex = 1\" class=\"btn  btnPrevious btn-next\">Previous</a>\n                  <button class=\"btn btn-primary btnNext btn-next\" type=\"submit\">\n                    Submit\n                  </button>\n                </div>\n              </div>\n            </div>\n          </mat-tab>\n        </mat-tab-group>\n      </form>\n    </section>\n  </div>\n</div>\n");
...
/* harmony import */ var _components_sign_in_sign_in_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/sign-in/sign-in.component */ "./src/app/components/sign-in/sign-in.component.ts");
...
const routes = [
    ...
    { path: 'sign-in', component: _components_sign_in_sign_in_component__WEBPACK_IMPORTED_MODULE_24__["SignInComponent"] },
...
/* harmony import */ var _components_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/sign-up/sign-up.component */ "./src/app/components/sign-up/sign-up.component.ts");
/* harmony import */ var _components_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/forgot-password/forgot-password.component */ "./src/app/components/forgot-password/forgot-password.component.ts");
/* harmony import */ var _components_verify_email_verify_email_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./components/verify-email/verify-email.component */ "./src/app/components/verify-email/verify-email.component.ts");
...
/* harmony import */ var _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! @angular/cdk/stepper */ "./node_modules/@angular/cdk/esm2015/stepper.js");
...
/* harmony import */ var _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! @angular/cdk/tree */ "./node_modules/@angular/cdk/esm2015/tree.js");
/* harmony import */ var _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! @angular/material/autocomplete */ "./node_modules/@angular/material/esm2015/autocomplete.js");
...
/* harmony import */ var _angular_material_stepper__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! @angular/material/stepper */ "./node_modules/@angular/material/esm2015/stepper.js");
/* harmony import */ var _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! @angular/material/datepicker */ "./node_modules/@angular/material/esm2015/datepicker.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var _angular_material_divider__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! @angular/material/divider */ "./node_modules/@angular/material/esm2015/divider.js");
...
/* harmony import */ var _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! @angular/material/grid-list */ "./node_modules/@angular/material/esm2015/grid-list.js");
/* harmony import */ var _angular_material_icon__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! @angular/material/icon */ "./node_modules/@angular/material/esm2015/icon.js");
/* harmony import */ var _angular_material_input__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! @angular/material/input */ "./node_modules/@angular/material/esm2015/input.js");
/* harmony import */ var _angular_material_list__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! @angular/material/list */ "./node_modules/@angular/material/esm2015/list.js");
/* harmony import */ var _angular_material_menu__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! @angular/material/menu */ "./node_modules/@angular/material/esm2015/menu.js");
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(/*! @angular/material/core */ "./node_modules/@angular/material/esm2015/core.js");
/* harmony import */ var _angular_material_paginator__WEBPACK_IMPORTED_MODULE_64__ = __webpack_require__(/*! @angular/material/paginator */ "./node_modules/@angular/material/esm2015/paginator.js");
/* harmony import */ var _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(/*! @angular/material/progress-bar */ "./node_modules/@angular/material/esm2015/progress-bar.js");
...
/* harmony import */ var _angular_material_radio__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(/*! @angular/material/radio */ "./node_modules/@angular/material/esm2015/radio.js");
/* harmony import */ var _angular_material_select__WEBPACK_IMPORTED_MODULE_68__ = __webpack_require__(/*! @angular/material/select */ "./node_modules/@angular/material/esm2015/select.js");
...
/* harmony import */ var _angular_material_slider__WEBPACK_IMPORTED_MODULE_70__ = __webpack_require__(/*! @angular/material/slider */ "./node_modules/@angular/material/esm2015/slider.js");
/* harmony import */ var _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_71__ = __webpack_require__(/*! @angular/material/slide-toggle */ "./node_modules/@angular/material/esm2015/slide-toggle.js");
/* harmony import */ var _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_72__ = __webpack_require__(/*! @angular/material/snack-bar */ "./node_modules/@angular/material/esm2015/snack-bar.js");
/* harmony import */ var _angular_material_sort__WEBPACK_IMPORTED_MODULE_73__ = __webpack_require__(/*! @angular/material/sort */ "./node_modules/@angular/material/esm2015/sort.js");
/* harmony import */ var _angular_material_table__WEBPACK_IMPORTED_MODULE_74__ = __webpack_require__(/*! @angular/material/table */ "./node_modules/@angular/material/esm2015/table.js");
/* harmony import */ var _angular_material_tabs__WEBPACK_IMPORTED_MODULE_75__ = __webpack_require__(/*! @angular/material/tabs */ "./node_modules/@angular/material/esm2015/tabs.js");
/* harmony import */ var _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_76__ = __webpack_require__(/*! @angular/material/toolbar */ "./node_modules/@angular/material/esm2015/toolbar.js");
/* harmony import */ var _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_77__ = __webpack_require__(/*! @angular/material/tooltip */ "./node_modules/@angular/material/esm2015/tooltip.js");
/* harmony import */ var _angular_material_tree__WEBPACK_IMPORTED_MODULE_78__ = __webpack_require__(/*! @angular/material/tree */ "./node_modules/@angular/material/esm2015/tree.js");
/* harmony import */ var _forms_material__WEBPACK_IMPORTED_MODULE_79__ = __webpack_require__(/*! ./forms/material */ "./src/app/forms/material.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_33__["SignUpComponent"],
            _components_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_34__["ForgotPasswordComponent"],
            _components_verify_email_verify_email_component__WEBPACK_IMPORTED_MODULE_35__["VerifyEmailComponent"],
        ],
        imports: [
            ...
            _angular_forms__WEBPACK_IMPORTED_MODULE_36__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_37__["BrowserAnimationsModule"],
            _forms_material__WEBPACK_IMPORTED_MODULE_79__["MaterialModule"],
            _angular_material_tabs__WEBPACK_IMPORTED_MODULE_75__["MatTabsModule"],
            ...
            _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_47__["MatBottomSheetModule"],
            _angular_material_button__WEBPACK_IMPORTED_MODULE_48__["MatButtonModule"],
            _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_49__["MatButtonToggleModule"],
            _angular_material_card__WEBPACK_IMPORTED_MODULE_50__["MatCardModule"],
            _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_51__["MatCheckboxModule"],
            _angular_material_chips__WEBPACK_IMPORTED_MODULE_52__["MatChipsModule"],
            _angular_material_stepper__WEBPACK_IMPORTED_MODULE_53__["MatStepperModule"],
            _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_54__["MatDatepickerModule"],
            _angular_material_dialog__WEBPACK_IMPORTED_MODULE_55__["MatDialogModule"],
            _angular_material_divider__WEBPACK_IMPORTED_MODULE_56__["MatDividerModule"],
            _angular_material_expansion__WEBPACK_IMPORTED_MODULE_57__["MatExpansionModule"],
            _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_58__["MatGridListModule"],
            ...
            _angular_material_list__WEBPACK_IMPORTED_MODULE_61__["MatListModule"],
            _angular_material_menu__WEBPACK_IMPORTED_MODULE_62__["MatMenuModule"],
            _angular_material_core__WEBPACK_IMPORTED_MODULE_63__["MatNativeDateModule"],
            _angular_material_paginator__WEBPACK_IMPORTED_MODULE_64__["MatPaginatorModule"],
            _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_65__["MatProgressBarModule"],
            ...
            _angular_material_select__WEBPACK_IMPORTED_MODULE_68__["MatSelectModule"],
            _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_69__["MatSidenavModule"],
            _angular_material_slider__WEBPACK_IMPORTED_MODULE_70__["MatSliderModule"],
            _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_71__["MatSlideToggleModule"],
            _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_72__["MatSnackBarModule"],
            _angular_material_sort__WEBPACK_IMPORTED_MODULE_73__["MatSortModule"],
            _angular_material_table__WEBPACK_IMPORTED_MODULE_74__["MatTableModule"],
            _angular_material_tabs__WEBPACK_IMPORTED_MODULE_75__["MatTabsModule"],
            _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_76__["MatToolbarModule"],
            _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_77__["MatTooltipModule"],
            _angular_material_tree__WEBPACK_IMPORTED_MODULE_78__["MatTreeModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".confirm-main-container\n{\n    padding-left: 8px;\n    padding-right: 8px;\n}\n.confirm-first-container\n{\n    background-color: white;\n    padding-bottom: 1px;\n}\n.table td, .table th {\n    padding: .75rem;\n    vertical-align: top;\n    border-top:none;\n}\n.confirm-page-heading {\n    margin-left: 16px;\n    /* margin-top: 9px; */\n    padding-top: 15px;\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 700;\n    color: black;\n    font-size: 16px;\n}\ntable {\n    margin-left: 11px;\n    margin-top: -15px;\n    display: flex;\n    justify-content: space-between;\n\n}\n.table td\n{\n padding: 5px;\n}\n.details-p-headings\n{\n    font-family: 'Open Sans', sans-serif;\n    font-weight: bold;\n    color: #5E5959;\n    font-size: 14px;\n\n}\n.output\n{\n    font-family: 'Open Sans', sans-serif;\n    font-weight: lighter;\n}\n.endind-button {\n    /* background-color: unset; */\n    display: flex;\n    justify-content: space-evenly;\n    align-content: center;}\n.btn.btn-back {\n        width: 33%;\n        background-color: #244D93;\n        /* height: 35px; */\n        color: white;\n        font-family: 'Open Sans', sans-serif;\n    }\n.btn-next{\n        width: 33%;\n        background-color: #244D93;\n        /* height: 35px; */\n        color: white;\n        font-family: 'Open Sans', sans-serif;\n    }\n.or-text {\n        display: flex;\n        justify-content: center;\n        align-content: center;\n    }\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".btn-facebook\n\n\n{\n background-color: #244D93;\n color: white;\n width: 30%;\n    height: 35px;\n    text-align: center;\n    margin: 0px;\n    padding: 0px;\n    font-family: 'Open Sans', sans-serif;\n}\n.btn-google\n{\n    background-color: #DD4B33;\n    color: white;\n    width: 30%;\n    height: 35px;\n    text-align: center;\n    margin: 0px;\n    padding: 0px;\n    font-family: 'Open Sans', sans-serif;\n}\n.social-login h4\n{\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 700;\n}\n.social-button {\n    display: flex;\n    /* justify-content: center; */\n    justify-content: space-evenly;\n    align-items: center;\n\n}\n.color-signup\n{\n    color: #244D93;\n}\n.btn-social-login\n{\n    width: 100%;\n    background-color: #244D93;\n    color: white;\n    margin-top: 3%;\n    font-family: 'Open Sans', sans-serif;\n  \n}\ni.fa.fa-user.input-group-text.nav-login-form{\n  position: absolute;\n  font-size: 23px;\n  left: 0px;\n  width: 10%;\n  z-index: 10;\n  margin-top: -4%;\n}\n.social-login.text-center {\n  padding: 15px;\n}\n.checkbox\n{\n  background: none transparent;\n     border: none; \n     border-left: none; \n     border-right: none; \n    cursor: pointer;\n    /* display: block; */\n    height: auto;\n    position: absolute;\n    top: none; \n     left: none; \n    right: 9px;\n     width: none; \n    /* transition: all .2s; */\n    display: flex;\n    flex-direction: row;\n\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".confirm-main-container\n{\n    padding-left: 8px;\n    padding-right: 8px;\n}\n.confirm-first-container\n{\n    background-color: white;\n    padding-bottom: 1px;\n}\n.table td, .table th {\n    padding: .75rem;\n    vertical-align: top;\n    border-top:none;\n}\n.confirm-page-heading {\n    margin-left: 16px;\n    /* margin-top: 9px; */\n    padding-top: 15px;\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 700;\n    color: black;\n    font-size: 16px;\n}\ntable {\n    margin-left: 11px;\n    margin-top: -15px;\n    display: flex;\n    justify-content: space-between;\n\n}\n.table td\n{\n padding: 5px;\n}\n.details-p-headings\n{\n    font-family: 'Open Sans', sans-serif;\n    font-weight: bold;\n    color: #5E5959;\n    font-size: 14px;\n\n}\n.output\n{\n    font-family: 'Open Sans', sans-serif;\n    font-weight: lighter;\n}\n.endind-button {\n    /* background-color: unset; */\n    display: flex;\n    justify-content: space-evenly;\n    align-content: center;}\n.btn.btn-back {\n        width: 33%;\n        background-color: #244D93;\n        /* height: 35px; */\n        color: white;\n        font-family: 'Open Sans', sans-serif;\n    }\n.btn-next{\n        width: 33%;\n        background-color: #244D93;\n        /* height: 35px; */\n        color: white;\n        font-family: 'Open Sans', sans-serif;\n    }\n.or-text {\n        display: flex;\n        justify-content: center;\n        align-content: center;\n    }\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".form-containers {\n  width: auto;\n\n  padding-right: 8px;\n  padding-left: 8px;\n}\n.forms-container {\n  padding-bottom: 4%;\n  \n}\n.row {\n  overflow-x: hidden;\n}\nnav {\n  background-color: #244d93;\n  padding-left: 20px;\n  padding-right: 20px;\n  border-radius: 11px;\n}\n.nav-link {\n  color: white;\n}\n.nav-tabs .nav-item.show .nav-link,\n.nav-tabs .nav-link.active {\n  color: #244d93;\n  background-color: #fff;\n  border-color: #dee2e6 #dee2e6 #fff;\n  font-family: \"Open Sans\", sans-serif;\n  font-weight: 700 !important;\n}\n.other-option {\n  display: flex;\n  justify-content: space-between;\n  align-content: center;\n}\n.nav-link {\n  display: block;\n  padding: 0rem 1rem;\n}\n.nav-tabs .nav-link.disabled {\n  color: white;\n}\ndiv#nav-tabContent {\n  width: auto;\n}\n.btn-facebook {\n  background-color: #244d93;\n  color: white;\n  width: 30%;\n  height: 35px;\n  text-align: center;\n  margin: 0px;\n  padding: 0px;\n  font-family: \"Open Sans\", sans-serif;\n}\n.btn-google {\n  background-color: #dd4b33;\n  color: white;\n  width: 30%;\n  height: 35px;\n  text-align: center;\n  margin: 0px;\n  padding: 0px;\n  font-family: \"Open Sans\", sans-serif;\n}\n.social-login h4 {\n  font-family: \"Open Sans\", sans-serif;\n  font-weight: 700;\n}\n.social-button {\n  display: flex;\n  /* justify-content: center; */\n  justify-content: space-evenly;\n  align-items: center;\n}\n.color-signup {\n  color: #244d93;\n}\n.btn-social-login {\n  width: 100%;\n  background-color: #244d93;\n  color: white;\n  margin-top: 3%;\n  font-family: \"Open Sans\", sans-serif;\n}\nbutton.btn.dropdown-toggle {\n  width: 100%;\n}\n.dropdown-menu.show {\n  width: 100%;\n}\n.dropdown-toggle::after {\n  margin-left: 0.255em;\n  vertical-align: 2.255em;\n  content: \"\";\n  border-top: 0.4em solid;\n  border-right: 0.4em solid transparent;\n  border-bottom: 0;\n  border-left: 0.4em solid transparent;\n  float: right;\n  text-align: center;\n  margin-top: 3%;\n}\n/* span.text-dropdown {\n    float: left;\n} */\n.dropdown-item {\n  text-align: center;\n}\nbutton.btn.dropdown-toggle {\n  width: 100%;\n  /* border: 1px solid grey; */\n  border: 1px solid #ced4da;\n}\n.endind-button {\n  /* background-color: unset; */\n  display: flex;\n  justify-content: space-evenly;\n  align-content: center;\n}\n.btn.btn-back {\n  width: 33%;\n  background-color: #244d93;\n  /* height: 35px; */\n  color: white;\n  font-family: \"Open Sans\", sans-serif;\n}\n.btn-next {\n  width: 33%;\n  background-color: #244d93;\n  /* height: 35px; */\n  color: white;\n  font-family: \"Open Sans\", sans-serif;\n}\n.or-text {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n}\n.second-container {\n  background-color: white;\n}\ninput#Tittle {\n  width: 20%;\n}\n.forms-heading {\n  font-family: \"Open Sans\", sans-serif;\n  font-weight: 700;\n}\n.forms-star {\n  font-family: \"Open Sans\", sans-serif;\n}\nlabel {\n  font-family: \"Open Sans\", sans-serif;\n  color: #707070;\n}\n.dropdown-item {\n  font-family: \"Open Sans\", sans-serif;\n  color: #707070;\n}\n.form-or-p {\n  border-radius: 50%;\n  width: 36px;\n  height: 26px;\n  /* padding: 8px; */\n  background: #fff;\n  border: 1px solid black;\n  color: #666;\n  text-align: center;\n  font: 19px \"Open Sans\", sans-serif;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.forms-or {\n  display: flex;\n  justify-content: center;\n}\n.form-or-p:before,\n.form-or-p:after {\n  background-color: #333;\n  content: \"\";\n  display: inline-block;\n  height: 1px;\n  position: relative;\n  vertical-align: middle;\n  width: 100%;\n}\n.form-or-p:before {\n  right: 0.5em;\n  margin-left: -100%;\n}\n.form-or-p:after {\n  left: 0.5em;\n  margin-right: -100%;\n}\n.drop-down-list {\n  height: 35px;\n  width: 100%;\n}\ninput {\n  padding: 10px;\n  width: 100%;\n  font-size: 15px;\n  font-family: Raleway;\n  border: 1px solid #aaaaaa;\n}\n.nav-link:active {\n  background-color: #244d93;\n  color: white;\n}\n/* Mark the steps that are finished and valid: */\n/*.step.finish {\n  background-color: #244D93\n}\n\n\n \n  #regForm {\n    background-color: #ffffff;\n    margin: 100px auto;\n    font-family: Raleway;\n    padding: 40px;\n    width: 70%;\n    min-width: 300px;\n  }\n  \n  \n  \n  input {\n    padding: 10px;\n    width: 100%;\n    font-size: 17px;\n    font-family: Raleway;\n    border: 1px solid #aaaaaa;\n  }\n  \n /\n  input.invalid {\n    background-color: #ffdddd;\n  }\n  \n  .tab {\n    display: none;\n  }\n  \n\n  \n  button:hover {\n    opacity: 0.8;\n  }\n  \n  #prevBtn {\n    background-color: #bbbbbb;\n  }\n  \n\n  .step {\n    height: 15px;\n    width: 15px;\n    margin: 0 2px;\n    background-color: #bbbbbb;\n    border: none;  \n    border-radius: 50%;\n    display: inline-block;\n    opacity: 0.5;\n  }\n  \n  .step.active {\n    opacity: 1;\n  }\n  \n\n  .step.finish {\n    background-color: #4CAF50;\n  }\n  .next-button {\n    display: flex;\n    justify-content: center;\n} */\n.mat-tab-header-pagination-controls-enabled .mat-tab-header-pagination {\n  display: none !important;\n}\n.mat-tab-header-pagination.mat-tab-header-pagination-before.mat-elevation-z4.mat-ripple {\n  display: none;\n}\n.mat-tab-header {\n  display: flex;\n  overflow: hidden;\n  position: relative;\n  flex-shrink: 0;\n  margin: 0px;\n  padding: 0px;\n  background: burlywood;\n}\n.form-tab-conatiner {\n  background-color: white;\n}\n.mat-tab-header-pagination {\n  display: none !important;\n}\n.example-button-row button,\n.example-button-row a {\n  margin-right: 8px;\n}\n.button-next {\n  display: flex;\n  justify-content: center;\n  padding: 17px;\n}\n.button-next-tab2 {\n  display: flex;\n  justify-content: space-evenly;\n  align-items: center;\n  margin: 20px;\n}\n.loading-container {\n  width: 100%;\n  height: 100%;\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 9;\n  background: black;\n  opacity: 0.5;\n}\n.form-check-input\n{\n  width: auto;\n\n}\n.last-radio-button\n{\n  margin-right: 0px;\n}\n.radio-align {\n\n  flex-direction: column;\n  margin: 0;\n  display: flex;\n\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let FormsComponent = class FormsComponent {
    ...
    formsService, firestore, afAuth, db) {
        this.authService = authService;
        this.afs = afs;
    ...
    save() {
        this.return = this.formsService
            .createCustomer(this.userData.uid, this.Buyer)
            .then(data => {
            if (data == true) {
                this.isLoading = false;
                alert("Data Saved");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".nav-tabs .nav-link.active {\n  font-weight:bold;\n  background-color: #F5F5F5;\n  font-family: 'Open Sans', sans-serif;\n  border-right: none;\n  border-left: none;\n  border-top: none;\n  color: black;\n}\n.nav-tabs .nav-link\n{\n  font-family: 'Open Sans', sans-serif;\n  color: black; \n  background-color: #CCCCCB;\n}\n.col-12{\n  padding-right: 0px;\n  padding-left: 0px;\n}\n.own-property-container\n{\n  padding-left: 8px;\n  padding-right: 8px;\n}\n.own-porpety-text {\n  padding-right: 10px;\n  padding-left: 10px;\n\n}\na#pop1-tab {\n  font-size: 12px;\n}\na#pop2-tab {\n  font-size: 12px;\n}\n.owna-property-text {\n  font-size: 18px;\n  font-family: 'Open Sans', sans-serif;\n\n}\n.own-property-list {\n  padding-right: 15px;\n  padding-left:0px;\n  text-align: justify;\n  font-family: 'Roboto', sans-serif;\n  font-weight: medium;\n}\nul.own-property-list-style {\n  font-size: 15px;\n  text-align: justify;\n  list-style: none;\n\n}\n.own-property-image\n{\n  background-image: url(\"/assets/Images/image-new.png\");\n  height: 305px;\n  background-repeat: no-repeat;\n\nbackground-size: cover;\n    margin: 0px;\n    padding: 0px;\n    margin-bottom: 10px;\n\n}\n.own-property-image-text{\n  position: relative; \n  /* top: 227px; */\n  position: absolute;\n  top: 30%;\n  text-align: center;\n  margin: 0px;\n  padding: 0px;\n  font-size: 21px;\n  text-transform: capitalize;\n  font-family: 'Roboto', sans-serif;\n  font-weight: medium;\n\n}\n.btn-own-property-offer {\n  width: 90%;\n  background-color: #244D93;\n  color: white;\n  text-transform: uppercase;\n  font-family: 'Open Sans', sans-serif;\n}\n.home-page-valuation {\n  width: 100%;\n}\n.own-property-home-worth{\n  background-color: white;\n}\n.own-property-text-home-worth {\n  text-align: left;\n  margin-bottom: .5em;\n  padding-left: 31px;\n  font-family: 'Open Sans', sans-serif;\n  font-weight: 400;\n}\n.own-property-text-home-worth-ans {\n  text-align: left;\n  padding-left: 31px;\n  padding-right: 31px;\n  font-family: 'Roboto', sans-serif;\n  font-weight: 400;\n}\n.own-property-blog\n{\n  background-color: white;\n  padding-bottom: 5px;\n}\n.own-property-blog-heading {\n  font-size: 25px;\n  text-transform: uppercase;\n  font-family: 'Open Sans', sans-serif;\n  font-weight: 400;\n}\n.own-property-blog-image {\n  width: 23%;\n  margin-right: 9px;\n  margin-left: 5px;\n}\n.own-property-blogs-content-c1 {\n  /* margin-right: 88px; */\n  text-align: left;\n  margin-bottom: 0;\n  font-family: 'Open Sans', sans-serif;\n  font-weight: 400;\n  font-size: 16px;\n}\n.own-property-blogs-content-c2 {\n  text-align: left;\n  font-family: 'Roboto', sans-serif;\n  font-weight: 400;  \n  font-size: 15px;\n\n}\n.own-property-blogs-content-c1-2 {\n  text-align: left;\n  margin: 0;\n  font-family: 'Open Sans', sans-serif;\n  font-weight: 400;\n  font-size: 16px;\n}\n.own-property-blogs-content-c2-2 {\n  text-align: left;\n  font-family: 'Roboto', sans-serif;\n  font-weight: 400;  \n  font-size: 15px;\n}\nhr {\n  margin-top: 3rem;\n  margin-bottom: 1rem;\n  border: 0;\n  border-top: 2px solid grey;\n  margin-right: 20px;\n    margin-left: 20px;\n}\n.own-property-last-image {\n  width: -webkit-fill-available;\n}\n.own-property-last-image-text {\n  text-align: left;\n  margin-left: 20px;\n  font-family: 'Open Sans', sans-serif;\n  font-weight: 400;\n  margin-top: 10px;\n}\n.own-property-last-line\n{\n  font-family: 'Roboto', sans-serif;\n  font-weight: 400; \n}\nli {\n  display: flex;\n  justify-content: flex-start;\n  align-items: end;\n}\n.Looking-property-image\n{\n  background-image: url(\"/assets/Images/image-new2.png\");\n  height: 305px;\n  background-repeat: no-repeat;\n\nbackground-size: cover;\n    margin: 0px;\n    padding: 0px;\n    margin-bottom: 10px;\n\n}\n.looking-property-image-text{\n  position: relative; \n  /* top: 227px; */\n  position: relative;\n  top: 76%;\n  text-align: center;\n  margin: 0px;\n  padding: 0px;\n  font-size: 23px;\n  text-transform: capitalize;\n  font-family: 'Roboto', sans-serif;\n\n\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let SellerformComponent = class SellerformComponent {
    constructor(authService, afs, // Inject Firestore service
    afAuth, firestore, SellerformService) {
        this.authService = authService;
        this.afs = afs;
        this.afAuth = afAuth;
        this.firestore = firestore;
